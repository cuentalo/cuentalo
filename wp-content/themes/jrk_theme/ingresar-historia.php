...
//			'meta_input'	=> $meta	
	...
	// Variables del Form
	//  OJO: solo tomò 'descripcion' y 'narra'
	$editor_id 		= 'descripcion';
	$editor_id2 	= 'narra';
	$editor_pob 	= 'poblacion';
	$editor_dir 	= 'direccion';
   	$settings  		= array('textarea_id' => 'descripcion', 'textarea_rows' => 7); 
	$settings_narr  = array('wpautop' => true, 'textarea_name' => 'narra', 'textarea_rows' => 15); 
				...
				<div class="form-group">
					<?php if ($categoria=='Historia') { ?>
						<?php if ($accion!='editar') { ?>					
							...
							<?php if ( $user_id == $author_id ) { //$user == $a_nickname
