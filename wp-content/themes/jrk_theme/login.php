...
<section class="py-5 bg-gris">
	<div class="container">		
    	<form name="loginform" method="post" action="http://cuentalo.org/login">
			...
			<div class="row">
			  ...
			  <div class="col">
					<div class="bg-items p-5 grupo-campos card title-color-site">
						...
						<div class="form-group">
							<label for="inputEmail4">Para participar en los Grupos e Historias de Cuentalo, usted necesita tener una cuenta.</label>		
						</div>																	
						<div class="form-group">
							...
							<p><a href="<?php echo $url ?>">Crear cuenta</a></p>
						</div>
					 </div>
			  </div>																	
		</div>
