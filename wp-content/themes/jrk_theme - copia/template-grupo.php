...
<div class="portada-grupo p-4">
	<div class="container">
		...
		<div class="menu-grupo py-2">
			<a href="#"><i class="fa fa-plus" aria-hidden="true"></i> Registrar grupo</a>
			<a href="#"><i class="fa fa-history" aria-hidden="true"></i> Historias</a>
		...
		<section class="row">
				<article>       
						<div class="noticias-actuales py-4">
						  <?php query_posts('category_name=grupo'); ?>
