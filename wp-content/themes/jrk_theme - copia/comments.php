...
<div id="comments" class="comments-area">
    ...
    <?php 
            ...
            comment_form(array(
                ...
                'comment_field' => '<textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" placeholder="' . __('Escribe tu opinión...', 'perla') . '"></textarea>', //Borrar párrafo y label del textarea
